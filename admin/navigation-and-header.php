...
$TOTALMESSAGES = $MESSAGEMEMBER + $MESSAGECOMPANY + $MESSAGEACANCY;


$ACTIVEFEEDBACK = count(FeedBack::activeFeedBack());
$INACTIVEFEEDBACK = count(FeedBack::pendingFeedBack());

$TOTALFEEDBACK = $ACTIVEFEEDBACK + $INACTIVEFEEDBACK;
?>
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    <a href="" class="dropdown-toggle" data-toggle="dropdown" role="button">
                        ...
                        <span class="label-count"><?php echo($TOTALMESSAGES); ?></span>
                    </a>
                            ...
                            <ul class="menu">
                                <li>
                                    <a href="manage-messages-member.php">
                                        ...
                                        <div class="menu-info">
                                            <h4><?php echo($MESSAGEMEMBER); ?> &nbsp;<span>Member Messages</span></h4>
                                        </div>
                                    </a>
                                </li>
                                <li>
                                    <a href="manage-messages-company.php">
                                        ...
                                        <div class="menu-info">
                                            <h4><?php echo($MESSAGEACANCY) ?> &nbsp;<span>Company Messages</span></h4>
                                        </div>
                                    </a>
                                </li>
                                <li>
                                    <a href="manage-messages-vacancy.php">  
                                        ...
                                        <div class="menu-info">
                                            <h4><?php echo ($MESSAGEACANCY); ?> &nbsp;<span>Vacancy Messages</span></h4>       
                                        </div>
                ...
                <li class="dropdown">
                    <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" role="button">
                        ...
                        <span class="label-count"><?php echo ($TOTALFEEDBACK); ?></span>
                    </a>
                    <ul class="dropdown-menu">
                            ...
                            <ul class="menu tasks">
                                <li>
                                    <a href="manage-messages-company.php">
                                        ...
                                        <div class="menu-info">
                                            <h4><?php echo ($ACTIVEFEEDBACK); ?> &nbsp;<span>Active Feedback</span></h4>
                                        </div>
                                    </a>
                                </li>
                                <li>
                                    <a href="manage-messages-vacancy.php">  
                                        ...
                                        <div class="menu-info">
                                            <h4><?php echo ($INACTIVEFEEDBACK); ?> &nbsp;<span>Inactive Feedback</span></h4>       
                                        </div>
