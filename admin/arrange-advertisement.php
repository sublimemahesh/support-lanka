...
<html> 
    <head>
        ...
        <title>Arrange Advertisement || Admin || Support Lanka</title>
        <!-- Favicon-->
                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            ...
                            <div class="body">
                                <form method="post" action="post-and-get/advertisement.php" class="form-horizontal" >
                                            ...
                                            <div class="col-md-12 arrange-container">
                                                <ul id="sortable">
                                                    ...
                                                    if (count($ADVERTISEMENT) > 0) {
                                                        foreach ($ADVERTISEMENT as $key => $img) {
                                                            ?>
                                                            <div class="col-md-3" style="list-style: none;">
                                                                <li class="ui-state-default">
                                                                    <span class="number-class">(<?php echo $key + 1; ?>)</span>                                                                  
                                                                    <img src="../upload/advertisement/thumb/<?php echo $img["image_name"]; ?>" class="img-responsive">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12 text-center" style="margin-top: 19px;">
                                                        <input type="submit" class="btn btn-info" id="btn-submit" value="Save Changes" name="save-data">
                                                    </div>
                                                </div>
                                            </div>
                                        </div> 
