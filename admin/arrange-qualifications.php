...
<html> 
    <head>
        ...
        <title>Admin || Arrange Qualification || Support Lanka</title>
        <!-- Favicon-->
                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            ...
                            <div class="body">
                                <form method="post" action="post-and-get/qualification.php" class="form-horizontal" >
                                            ...
                                            <div class="col-md-12 arrange-container">
                                                <ul id="sortable">
                                                    ...
                                                    if (count($QUALIFICATION) > 0) {
                                                        foreach ($QUALIFICATION as $key => $img) {
                                                            ?>
                                                            <div class="col-md-3" style="list-style: none;">
                                                                <li class="ui-state-default">
                                                                    ...
                                                                    <div><b>Skill :  </b>
                                                                        <?php
                                                                        $SKILL = new Skill($img['skill']);
                                                                        echo $SKILL->name;
                                                                        ?>
                                                                    </div>
                                                                    <div><b>Qualification :  </b><?php echo $img["name"]; ?></div>
