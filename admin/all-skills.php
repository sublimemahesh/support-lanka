                                                        ...
                                                        foreach ($INDUSTRY as $key => $industry) {
                                                            ...
                                                            <div class="col-md-3" style="list-style: none;">
                                                                <li class="ui-state-default">
                                                                    ...
                                                                    <a href="arrange-skills.php?id=<?php echo $industry['id'];?>"><div><img src="../upload/industry/thumb/<?php echo $industry['image_name']?>" width="40%" >  
                                                                        </div></a>
                                                                    <div><?php
                                                                        foreach ($skill = Skill::all() as $key => $skill) {
                                                                            if ($key === 1) {
                                                                                break;
                                                                            }
                                                                            ?>
                                                                            <b>Skill :  </b><?php echo $skill["name"]; ?>
                                                                        <?php }
                                                                        ?>
                                                                    </div>
