...
<html lang="en">
    ...
    <head>
        ...
        <title>Add New Award || My Account || Support Lanka</title>
                    ...
                    <div class="container-fluid">
                        <div class="row top-bott20"> 
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading"><i class="fa fa-pencil"></i> Create Award</div>
                                                                ...
                                                                <div class="panel-body">
                                                                    ...
                                                                    <div class="form-group top-bott50 col-md-12">
                                                                        <div class="bottom-top">
                                                                            ...
                                                                            <button name="add-award" type="submit" class="btn btn-info center-block">Create</button>
                                                                        </div>
                                                                    </div>
                                                                </div>
