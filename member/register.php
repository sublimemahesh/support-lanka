                        ...
                        <div id="login" class="tab-pane fade in active">
                            <div class="col-md-12 row-marging">
                                ...
                                <form action="post-and-get/member.php" method="POST">
                                    <input name="nic_number" placeholder="NIC_Number" class="inputbox" type="text">
                        ...
                        <div id="register1" class="tab-pane fade">
                            <div class="margin-l-20">
                                <form id="register" method="post"> 
                                    <input name="nic_number"  placeholder="Enter Your NIC Number" class="inputbox" type="text"  >
                                    ...
                                    <div>
                                        ...
                                        <div class="buttn-bottom res-btn"  >
                                            <div class="pull-left text-danger btn-padding font-size-new" id="message1"></div>
                                            <div class=" padding_style btn-padding btn-new-padding" >
