                                ...
                                <div class="our-services">
                                    <div class="row">
                                        <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                                            <h3 class="about">Vission</h3>
                                            <div class="service">
                                                <i class="la la-eye"></i><div class="service-info"><h3>Advertise A Job</h3><p>Duis a tristique lacus. Donec vehicula ante id lorem venenatis posuere. Morbi in lectus.</p></div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                                            <h3 class="about">Mision</h3>
                                            <div class="service">
                                                <i class="la la-rocket"></i><div class="service-info"><h3>CV Search</h3><p>Duis a tristique lacus. Donec vehicula ante id lorem venenatis posuere. Morbi in lectus.</p></div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                                            <h3 class="about">Value</h3>
                                            <div class="service">
                                                <i class="la la-hourglass-2"></i><div class="service-info"><h3>Recruiter Profiles</h3><p>Duis a tristique lacus. Donec vehicula ante id lorem venenatis posuere. Morbi in lectus.</p></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
