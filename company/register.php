                    ...
                    <div class="col-md-12 col-sm-12 m-padding" >
                        <ul class="nav nav-tabs M-new">
                            <li class="active nav-tabs-active lo-register">
                                <a data-toggle="tab" href="#login" class="color-b"  aria-expanded="false">Login</a></li>
                            <li class="nav-tabs-active  lo-register  "><a data-toggle="tab" href="#register1" class="color-b" aria-expanded="true">Register</a></li>
                        </ul>
                    </div>
